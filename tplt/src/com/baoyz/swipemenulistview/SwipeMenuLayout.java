...
public class SwipeMenuLayout extends FrameLayout {
	...
	public SwipeMenuLayout(View contentView, SwipeMenuView menuView) {
		this(contentView, menuView, null, null, false);
	}

	public SwipeMenuLayout(View contentView, SwipeMenuView menuView,
			Interpolator closeInterpolator, Interpolator openInterpolator, boolean mSwipEnable) {
	...
	private void init() {
		...
		if(this.mSwipEnable) addView(mMenuView);
